...
LOG_STEP_IN "- Setting system locale to zh-CN"
SET_PROP "system" "ro.product.locale" "zh-CN"
LOG_STEP_OUT
...
LOG_STEP_IN "- Disabling verbose Samsung system logging (persist.log.level/semlevel) and network log tags"
SET_PROP "system" "persist.log.level" "0"
SET_PROP "system" "persist.log.semlevel" "0"
SET_PROP "system" "log.tag.ConnectivityManager" "I"
SET_PROP "system" "log.tag.ConnectivityService" "I"
SET_PROP "system" "log.tag.NetworkLogger" "I"
SET_PROP "system" "log.tag.IptablesRestoreController" "I"
SET_PROP "system" "log.tag.ClatdController" "I"
LOG_STEP_OUT
...
{
    echo ""
    echo "    <!-- Indicate support for the Android security model per the CDM. -->"
